...
def import_countries():
    data_reader = csv.reader(open("/app/smrpo/smrpo/data_scripts/Country.csv"), delimiter=',',
                             quotechar='"')
    next(data_reader)
...
def import_nationalities():
    data_reader = csv.reader(open("/app/smrpo/smrpo/data_scripts/Nationality.csv"), delimiter=',',
                             quotechar='"')
    next(data_reader)
...
def import_regions():
    data_reader = csv.reader(open("/app/smrpo/smrpo/data_scripts/Region.csv"), delimiter=',',
                             quotechar='"')
    next(data_reader)
...
def import_universities():
    data_reader = csv.reader(open("/app/smrpo/smrpo/data_scripts/University.csv"), delimiter=',',
                             quotechar='"')
    next(data_reader)
...
def import_professions():
    data_reader = csv.reader(open("/app/smrpo/smrpo/data_scripts/Profession.csv"), delimiter=',',
                             quotechar='"')
    next(data_reader)
...
def import_faculties():
    data_reader = csv.reader(open("/app/smrpo/smrpo/data_scripts/Faculty.csv"), delimiter=',',
                             quotechar='"')
    next(data_reader)
...
def import_posts():
    data_reader = csv.reader(open("/app/smrpo/smrpo/data_scripts/Post.csv"), delimiter=',',
                             quotechar='"')
    next(data_reader)
...
def import_high_schools():
    data_reader = csv.reader(open("/app/smrpo/smrpo/data_scripts/HighSchool.csv"), delimiter=',',
                             quotechar='"')
    next(data_reader)
...
def import_courses():
    data_reader = csv.reader(open("/app/smrpo/smrpo/data_scripts/Course.csv"), delimiter=',',
                             quotechar='"')
    next(data_reader)
...
def import_study_programs():
    data_reader = csv.reader(open("/app/smrpo/smrpo/data_scripts/StudyProgram.csv"), delimiter=',',
                             quotechar='"')
    next(data_reader)
...
def import_finished_educations():
    data_reader = csv.reader(open("/app/smrpo/smrpo/data_scripts/FinishedEducation.csv"),
                             delimiter=',', quotechar='"')
    next(data_reader)
...
def reset_database():
    ...
    os.system("sudo python3.4 /app/smrpo/smrpo/manage.py makemigrations")
    os.system("sudo python3.4 /app/smrpo/smrpo/manage.py migrate")
...
def create_user(first_name, last_name):
    user = User.objects.create_user(first_name + last_name,
                                    "lovropodgorsek@gmail.com", "qweasd123")
